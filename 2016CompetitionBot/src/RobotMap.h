...
#define BATTER_WALL_HOOD_HEIGHT 1180
#define BATTER_WALL_TURRET_ENC_LEFT 5422
#define BATTER_WALL_TURRET_ENC_RIGHT (-5450)
#define SHOOTER_WALL_HOOD_HEIGHT 460
#define SHOOTER_WALL_TURRET_ENC 0

//////////////////////// Vision Math Constants /////////////////////
//Distance
#define DISTANCE_EQUATION_QA 0.000095770291 //0.000080698946 //0.000082410 //Old: 0.00010046 //OLDer: 0.00008217
#define DISTANCE_EQUATION_QB 0.0014558 //0.0046238 //0.005409 //Old: -0.00026929 //OLDer: 0.00161487
#define DISTANCE_EQUATION_QC 1.3934739 //1.4509617 //1.318080 //Old: 1.39859538 //OLDer: 1.34776440
//Rotation
#define ROTATION_EQUATION_LM 5.913291 //7.607226 // waterloo 8.963565 //Old: 6.8503 //OLDer: 5.7811
#define ROTATION_EQUATION_LB 91.876426 //87.837164 // waterloo 73.949064 //Adjusted LB becaues of bracket mounted to the left  Old: 77.349 //OLDer: 58.443

//Tilt Height
#define HEIGHT_EQUATION_QA -129.179331 //-164.13373860//OLD: -161.052143 // OLD:-213.724
#define HEIGHT_EQUATION_QB 853.875380 //924.1945288//OLD: 1041.246165  // OLD: 1561.49
#define HEIGHT_EQUATION_QC 337.829787//51.4711246201//OLD: -43.805191 // OLD: (-410.8)
...
#define POSITION_THREE_APPROACH_DISTANCE 1500
#define POSITION_THREE_RIGHT_APPROACH_DISTANCE 3750
#define POSITION_FOUR_APPROACH_DISTANCE 1600
